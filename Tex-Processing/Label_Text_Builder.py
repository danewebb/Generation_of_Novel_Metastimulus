...
class Label_Text_Builder():
    ...
    def __unique_tag_list(self, tags):
        for tag in tags:
...
if __name__ == '__main__':
    ...
    #
    # with open('training_dict.pkl', 'rb') as train_file:
    ...
    #     tag_dict[key] = tag_dict_temp['tags']
    #
    #     para_dict_temp = dict()
    #     para_dict_temp = value['']
